...
def initiate():
    ...
    car_model_data = [
        ...
        {"name": "Altima", "type": "Sedan", "year": 2021, "car_make": car_make_instances["NISSAN"]},
        ...
        # Dodge
        {"name": "Durango", "type": "SUV", "year": 2014, "car_make": car_make_instances["Dodge"]},

        # Honda
        {"name": "Accord", "type": "Sedan", "year": 2020, "car_make": car_make_instances["Honda"]},
    ]
